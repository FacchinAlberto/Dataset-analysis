...
author: "Gruppo F: Alberto Facchin, Andrea Tonello, Leonardo Micheluz, Lorenzo Cusin"
date: "28-06-2023"
---
...
wholesale = read.csv("Wholesale customers data.csv", header = T, stringsAsFactors = T)
str(wholesale)
dim(wholesale)
